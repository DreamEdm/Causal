function [Base_Target_Index] = WeightJudgeCutNode_DynamicTesting(Path, Path_dense, Base_num)
%WEIGHTJUDGECUTNODE Combined strategy
% Used to test the impact of different E-step paramters on the high-dimension network
    Target_flag = false;
    ...
    Index_weight = Base_num ^ temp - Base_num;
