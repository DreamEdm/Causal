...
for i  = 1:node-1
    for j = i+1:node
        if Ind_Temp(i,j) == 0 && Ind_Temp(j,i) == 0 
            for k = 1:node
                if i ~= k && j ~= k && Ind_Temp(i,k) == 0 && Ind_Temp(j,k) == 0  % �ڱ߲����ܴ���condiction
