function [RCP_skeleton,Acell,Bcell,Ccell,Time_CAPA_Opt_Partition,Time_PC_CAPA_Opt,originalSize_currentSize_maxSubsetSize] = PC_RCP_Opt(data,skeleton,conSize,Ds_order,Ds_Temp,Acell,Bcell,Ccell)
...
%      Time_Ds_Temp_ReCIT = toc
    ...
    [RCP_skeleton,RCP_Cell] = RCP_Opt_Main(data,data,RCP_skeleton,1:node,RCP_Cell,skeleton,Ds_Temp,0);
