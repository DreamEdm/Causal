function [RCP_skeleton,Acell,Bcell,Ccell,Time_CAPA_Partition,Time_PC_CAPA,origina lSize_currentSize_maxSubsetSize] = PC_CP(data,skeleton,conSize,Ds_order,Ds_Temp,Acell,Bcell,Ccell)
...
%      Time_Ds_Temp_ReCIT = toc
    ...
    tic3
    [RCP_skeleton,RCP_Cell] = CP_Main(data,data,RCP_skeleton,1:node,RCP_Cell,skeleton,Ds_Temp,0); % here par 0 used to limit the recusive time
