function [AVG_CPBG_Score, AVG_CAPA_Score, AVG_CP_Score, ...
    ...
    AVG_CPBG_ratio, AVG_CAPA_ratio, AVG_CP_ratio] = HalfRealTest_f(count, data_set_name, Sample)
    
    data_path = '..\CP_BaseGraph\dataset\Half-real-dataset\Skeleton\';
    suffix = '.mat';
    Times = 10;
    ...
    for Time = 1:Times
        %loading Skeleton
        counts_data_path = [data_path, data_set_name{count}, suffix];
        load(counts_data_path);
